...
def _acbl_report_panel() -> None:
    ...
    st.caption(
        ...
        "(or **Tournament_Sessions** / **Club_Sessions** for pairs) and "
        "**Tournament_Elo** / **Club_Elo** are sessions and chess-scaled "
        "published Elo in the other event type (club↔tournament crossover). "
