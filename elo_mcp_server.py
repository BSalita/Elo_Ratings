...
@mcp.tool()
def ffbridge_health() -> Dict[str, Any]:
    """FFBridge API build, dataset-schema, score-provenance, and quality status."""
    return _ffbridge_get("/health", {})
...
def ffbridge_player_history(
    ...
    Scoring_Mode, raw score provenance/status/source URL, Elo after the
    session, Results_URL, dataset schema version, and link coverage."""
    return _ffbridge_get(
